 ...
 */
@Configuration
//chi dinh databases.properties
@PropertySource("classpath:database.properties")
public class HibernateConfig {
    //tu day tro xuong, chi dinh cach set up connection

    @Autowired //pt tao bean Environment co roi, xai Autowired
    ...
    public LocalSessionFactoryBean getSessionFactory() {
        ...
        }); //chi dinh package chua pojo
        sessionFactory.setDataSource(dataSource());
        sessionFactory.setHibernateProperties(hibernateProperties());
        return sessionFactory;
    }

    //tu day tro xuong la gan nhu khong doi cho moi project
    @Bean
